...
parser.add_argument('--with_rank', type=bool, default=False)
parser.add_argument('--neural_ndcg_temp', type=float, default=0.05)
parser.add_argument('--loss_portion', type=float, default=0.5)
